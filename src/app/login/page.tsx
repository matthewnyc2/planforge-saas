    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50/60 via-background to-teal-50/30 px-4">
      ...
      <Card className="w-full max-w-md relative rounded-2xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription>Sign in to your PlanForge account</CardDescription>
        </CardHeader>
        <form onSubmit={onSubmit}>
          <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" placeholder="alice@demo.com" required className="rounded-xl" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password" className="font-medium">Password</Label>
              <Input id="password" name="password" type="password" placeholder="demo1234" required className="rounded-xl" />
            </div>
            <div className="bg-muted/40 text-sm p-4 rounded-xl">
              <p className="font-medium font-display mb-1.5">Demo Credentials</p>
              <p className="text-muted-foreground">Email: <code className="text-foreground bg-background/60 px-1.5 py-0.5 rounded">alice@demo.com</code></p>
              <p className="text-muted-foreground">Password: <code className="text-foreground bg-background/60 px-1.5 py-0.5 rounded">demo1234</code></p>
            </div>
          </CardContent>
